        ...
        <div style={{ width, position: 'relative', ...style }} ref={containerRef}>
            ...
            <div
                ...
                style={{
                    ...
                    width: '100%',
                    padding: '10px 14px',
                    background: disabled ? 'rgba(255,255,255,0.02)' : 'var(--bg-input, #0d0d10)',
                    border: isOpen ? '1px solid rgba(139,92,246,0.5)' : '1px solid var(--border-default, rgba(255,255,255,0.1))',
                    borderRadius: 'var(--radius-sm, 8px)',
                    color: value ? 'var(--text-main, #e4e4e7)' : 'var(--text-dim, #71717a)',
                    fontSize: '14px',
                    ...
                    boxShadow: isOpen
                        ? 'var(--shadow-glow-primary, 0 0 0 3px rgba(139,92,246,0.15)), inset 0 1px 2px rgba(0,0,0,0.15)'
